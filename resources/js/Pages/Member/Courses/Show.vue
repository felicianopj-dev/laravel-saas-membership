  ...
  <MemberLayout title="Course Overview">
    <div class="space-y-6">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div v-if="course.lessons.length" class="mt-6 divide-y divide-slate-200">
          <Link
        ...
        <div
            v-else
            class="mt-6 rounded-xl border border-dashed border-slate-300 p-6 text-sm text-slate-500"
        >
